                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 justify-center">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div> 
                                ...
                                <a href="tel:+91 9347482983" className="text-muted-foreground hover:text-primary transition-colors">
                                    +91 9347482983
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="p-3 rounded-full bg-primary/10">
                                <MapPin className="h-6 2-6 text-primary" />{" "}
                            </div>

                            <div>
                                <h4 className="font-medium"> Locaiton</h4>
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a href="https://www.linkedin.com/in/sayan-sengupta-93278a228/" target="_blank">
                                <Linkedin />
                            </a>
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="Hey can we connect..."
                            />
                        </div>
                        <button
                            type="submit"
